...
namespace KerazaWebApplication.Controllers
{
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,AddedBy,AddedOn,CategoryId")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,AddedBy,AddedOn,CategoryId,Caption,Date")] Event @event)
        {
            if (id != @event.Id)
            {
                return NotFound();
