...
namespace KerazaWebApplication.Controllers
{
    public class SpeakersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ImageURL,AddedBy,AddedOn")] Speaker speaker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ImageURL,AddedBy,AddedOn")] Speaker speaker)
        {
            if (id != speaker.Id)
            {
                return NotFound();
